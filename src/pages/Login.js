...
import { Visibility, VisibilityOff, LockOutlined, PersonOutlined, Air, Thermostat, AcUnit } from '@mui/icons-material'
    ...
    await axios
      ...
      .then((result) => {
        ...
        if (res === 'true' && result.data.id && result.data.token) {
          ...
          localStorage.setItem('admin_name', result.data.name || emailRef.current.value)
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
            ...
            <CardContent sx={{ p: { xs: 4, sm: 5, md: 6 } }}>
              <Slide direction="down" in={mounted} timeout={1000}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
                  ...
                  >
                    Sign in to your SecureMyAir Control Center
                  </Typography>
                  <Typography 
                    variant='body2' 
                    color='text.secondary'
              ...
              <TextField
                ...
                autoFocus
                    helperText={userError && 'Account not found. Please check your credentials.'}
                    InputProps={{
                      startAdornment: (
              ...
              <TextField
                ...
                autoComplete='current-password'
                    helperText={pwdError && 'Password is incorrect. Please try again.'}
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
        ...
        {dialog.status && <>{dialog.body === 'pas' ? <ResetPasswordDialog /> : <FaDialog email={email} />}</>}
      </Box>
    </ThemeProvider>
  )
}
